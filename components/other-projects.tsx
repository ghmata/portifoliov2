...
const otherProjects = [
  ...
  },
  {
    id: 3,
    name: "CONCAN",
    subtitle: "Gestão Financeira Mobile",
    description: "Controle de contas a pagar direto do celular. Para saber mais, clique em Detalhes.",
    fullDescription: "Aplicação web otimizada para dispositivos móveis, projetada para gestão financeira de pequenas operações. Substitui o controle via cadernos e WhatsApp por um sistema acessível de qualquer lugar.",
    image: "/concan-main.jpg",
    mobileImages: ["/concan-1.png", "/concan-2.png", "/concan-3.png"],
    technologies: ["Python", "Flask", "Jinja2", "SQLite"],
    features: ["100% mobile-first", "Alertas de vencimento", "Zero instalação", "Interface responsiva"],
    status: "Em produção",
    isMobile: true,
    githubUrl: "https://github.com/ghmata/concan",
  },
  {
    id: 4,
    name: "ClinicaBot",
